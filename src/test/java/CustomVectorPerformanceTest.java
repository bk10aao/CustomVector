...
public class CustomVectorPerformanceTest {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 500; i++) {
            CustomVector<Integer> warmUpVector = new CustomVector<>();
        ...
        try (FileWriter writer = new FileWriter("CustomVector_performance_data.csv")) {
    ...
    private static long benchmarkAddAtIndex(CustomVector<Integer> sourceVector, Random random, int size) {
        CustomVector<Integer> vector = new CustomVector<>(sourceVector);
    ...
    private static long benchmarkAddAllAtIndex(CustomVector<Integer> sourceVector, Collection<Integer> collection) {
        CustomVector<Integer> vector = new CustomVector<>(sourceVector);
        long start = System.nanoTime();
    ...
    private static long benchmarkClear(Collection<Integer> initialData) {
        CustomVector<Integer> vector = new CustomVector<>(initialData);
        long start = System.nanoTime();
        vector.clear();
        long duration = System.nanoTime() - start;
        blackHole = vector;
    ...
    private static long benchmarkClone(CustomVector<Integer> vector) {
        long start = System.nanoTime();
        CustomVector<Integer> clone = vector.clone();
        long duration = System.nanoTime() - start;
        blackHole = clone;
        return duration;
    }

    private static long benchmarkContains(CustomVector<Integer> vector, int size, Random random) {
    ...
    private static long benchmarkContainsAll(CustomVector<Integer> vector, Collection<Integer> collection) {
        long start = System.nanoTime();
    ...
    private static long benchmarkEquals(CustomVector<Integer> vector, Collection<Integer> collection) {
        CustomVector<Integer> other = new CustomVector<>(collection);
        long start = System.nanoTime();
    ...
    private static long benchmarkGet(CustomVector<Integer> vector, int size, Random random) {
    ...
    private static long benchmarkHashCode(CustomVector<Integer> vector) {
        int hash = 0;
        long start = System.nanoTime();
    ...
    private static long benchmarkIndexOf(CustomVector<Integer> vector, int size, Random random) {
        int[] queries = new int[BATCH_RUNS];
        for (int i = 0; i < BATCH_RUNS; i++) queries[i] = random.nextInt(size * 2);
        long start = System.nanoTime();
        int indexSum = 0;
    ...
    private static long benchmarkIsEmpty(CustomVector<Integer> vector) {
        boolean res = false;
        long start = System.nanoTime();
    ...
    private static long benchmarkLastIndexOf(CustomVector<Integer> vector, int size, Random random) {
        int[] queries = new int[BATCH_RUNS];
        for (int i = 0; i < BATCH_RUNS; i++) queries[i] = random.nextInt(size * 2);
        long start = System.nanoTime();
        int indexSum = 0;
    ...
    private static long benchmarkRemoveIndex(CustomVector<Integer> sourceVector, Random random) {
        if (sourceVector.isEmpty()) return 0;
        CustomVector<Integer> workingCopy = new CustomVector<>(sourceVector);
    ...
    private static long benchmarkRemoveObj(CustomVector<Integer> vector, int size, Random random) {
    ...
    private static long benchmarkRemoveAll(Collection<Integer> collection) {
        CustomVector<Integer> workingCopy = new CustomVector<>(collection);
        long start = System.nanoTime();
    ...
    private static long benchmarkSet(CustomVector<Integer> vector, int size, Random random) {
        CustomVector<Integer> workingCopy = new CustomVector<>(vector);
    ...
    private static long benchmarkSize(CustomVector<Integer> vector) {
        int finalSize = 0;
        long start = System.nanoTime();
    ...
    private static long benchmarkSubList(CustomVector<Integer> vector, int size) {
        int mid = size / 2;
        long start = System.nanoTime();
    ...
    private static long benchmarkToArray(CustomVector<Integer> vector) {
        long start = System.nanoTime();
    ...
    private static long benchmarkToArrayTyped(CustomVector<Integer> vector) {
    ...
    private static long benchmarkToString(CustomVector<Integer> vector) {
        long start = System.nanoTime();
